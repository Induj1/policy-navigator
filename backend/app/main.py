...
# Debug helper to verify zyndai-agent is actually importable in the running environment.
try:
    import zyndai_agent
    print("ZYND LOADED FROM:", zyndai_agent.__file__)
except ImportError as e:
    print("⚠ zyndai-agent is not importable at startup:", e)
...
app.add_middleware(
    CORSMiddleware,
    # Allow all origins so local dev (any localhost port) and production frontends can reach the API
    allow_origins=["*"],
